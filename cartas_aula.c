...
void imprime_botoes // nao esta completo

char onClickUrl[10240];
e.baralhar=1;
sprintf(onClickUrl, "%s?q=%s", SCRIPT, stateToString(stateAfterClick));

    printf("<a xlink:href = \"%s\"><image class=\"%s\" x = \"%d\" y = \"%d\" height = \"110\" width = \"80\" xlink:href = \"%s/baralhar.png\" /></a>\n", onClickUrl, cardElementClasses, x, y, BARALHO); // (path passou a baralho)
    e.baralhar=0;
    e.passar=1;
    printf("<a xlink:href = \"%s\"><image class=\"%s\" x = \"%d\" y = \"%d\" height = \"110\" width = \"80\" xlink:href = \"%s/Passa.png\" /></a>\n", onClickUrl, cardElementClasses, x+100, y, BARALHO); // (path passou a baralho)

    printf("<a xlink:href = \"%s\"><image class=\"%s\" x = \"%d\" y = \"%d\" height = \"110\" width = \"80\" xlink:href = \"%s/jogar_enabled.png\" /></a>\n", onClickUrl, cardElementClasses, x+200, y, BARALHO); // (path passou a baralho)
    // para nao dar para selecionar :
    // printf("<image class=\"%s\" x = \"%d\" y = \"%d\" height = \"110\" width = \"80\" xlink:href = \"%s/jogar_enabled.png\" />\n", onClickUrl, cardElementClasses, x+200, y, BARALHO); // (path passou a baralho)
